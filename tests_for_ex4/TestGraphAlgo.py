...
class TestGraphAlgo(unittest.TestCase):
    ...
    def test_load_save(self):
        ...
        new_algo = GraphAlgo()
        self.assertEqual(new_algo.load_from_json_file(file), True)
    ...
    def test_TSP(self):
        ...
        test_file = "../tests_for_ex4/TspTest.json"
        test_file_path = os.path.join(file_dir, test_file)
        my_graph_algo = GraphAlgo()
        my_graph_algo.load_from_json_file(test_file_path)
    ...
    def test_center(self):
        ...
        test_file = "../tests_for_ex4/CenterTest1.json"
        ...
        second_test_file = "../tests_for_ex4/CenterTest2.json"
        second_test_file_path2 = os.path.join(files_dir, second_test_file)
        my_second_graph_algo = GraphAlgo()
        my_second_graph_algo.load_from_json_file(second_test_file_path2)
        ...
        third_test_file = "../tests_for_ex4/CenterTest3.json"
        third_test_file_path = os.path.join(files_dir, third_test_file)
        my_third_graph_algo = GraphAlgo()
        my_third_graph_algo.load_from_json_file(third_test_file_path)
